    ...
    , ui(new Ui::MainWindow)
{
    ...
    //Background
    QPixmap bkgnd("C:\\Users\\Asus\\Desktop\\smart_cinema_\\Integration_abir\\bghexa.jpg");
    ...
    ui->tableView_employe_3->setSelectionBehavior(QAbstractItemView::SelectRows);
    ui->tableView_employe_3->setSelectionMode(QAbstractItemView::SingleSelection);
    ui->tableView_poste_3->setSelectionBehavior(QAbstractItemView::SelectRows);
...
void MainWindow::on_menuRES2_clicked()
{
    ui->stackedWidget->setCurrentIndex(9);
}

void MainWindow::on_menuRES1_clicked()
{
    ui->stackedWidget->setCurrentIndex(9);
}
...
void MainWindow::update_label()
{
    ...
    {
        temperature = temperature.left(5);
        ui->lcdNumber_temp->display(temperature.toFloat());
        if(temperature.toFloat() > 21)
        {
            QSystemTrayIcon *notifyIcon = new QSystemTrayIcon;
            notifyIcon->show();
            notifyIcon->setIcon(QIcon("icone.png"));
...
void MainWindow::on_checkBox_ENGLISH_clicked()
{
    ...
    notifyIcon->show();
    notifyIcon->setIcon(QIcon("icone.png"));
    notifyIcon->showMessage("LANGUAGE","Language has been changed.",QSystemTrayIcon::Information,15000);
...
void MainWindow::on_pushButton_refuserTEMP_clicked()
{
...
void MainWindow::on_toolButton_13_triggered(QAction *arg1)
{
...
void MainWindow::on_toolButton_15_triggered(QAction *arg1)
{
    my_class mc;
...
void MainWindow::on_toolButton_14_triggered(QAction *arg1)
{
    offre mc;
...
//mailing
void MainWindow::on_tableau_off_clicked(const QModelIndex &index)
{
      selectedo=ui->tableau_off->model()->data(index).toString();
}


void MainWindow::on_tableau_off_doubleClicked(const QModelIndex &index)
{
...
void MainWindow::on_recherche_off_textEdited(const QString &arg1)
{
      proxyo->setFilterFixedString(arg1);
}


void MainWindow::on_recherche_res_textEdited(const QString &arg1)
{
    proxyr->setFilterFixedString(arg1);
}

void MainWindow::on_tableau_res_clicked(const QModelIndex &index)
{
   selectedr=ui->tableau_res->model()->data(index).toInt();
}

void MainWindow::on_tableau_res_doubleClicked(const QModelIndex &index)
{
    add_class ac(this);
