...
private slots:
    ...
    void on_toolButton_13_triggered(QAction *arg1);

    void on_toolButton_15_triggered(QAction *arg1);

    void on_toolButton_14_triggered(QAction *arg1);
    ...
    void on_tabWidget_res_objectNameChanged(const QString &objectName);

    void on_sendBtn_clicked();

    void on_tableau_off_doubleClicked(const QModelIndex &index);

    void on_tableau_off_clicked(const QModelIndex &index);

    void on_recherche_off_textEdited(const QString &arg1);

    void on_recherche_res_textChanged(const QString &arg1);

    void on_recherche_res_textEdited(const QString &arg1);

    void on_tableau_res_clicked(const QModelIndex &index);

    void on_tableau_res_doubleClicked(const QModelIndex &index);

    void on_menuRES2_clicked();

    void on_menuRES1_clicked();

    void on_pushButton_refuserTEMP_clicked();
